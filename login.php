...
<body style="background: url(images/logo_bank.png);background-size: 100%">
<h1 class="alert alert-success rounded-0"><?php echo bankname; ?><small class="float-right text-muted" style="font-size: 12pt;"><kbd>Presented by: Group-1</kbd></small></h1>
<br>
<?php echo $error ?>
<br>
